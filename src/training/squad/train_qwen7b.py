"""
Train Qwen2.5-7B on SQuAD 2.0 (groups A, B1, B2, C).
...
OUTPUT_BASE = QWEN_7B_SQUAD_ADAPTER
...
# ------------------------------------------------------------------
print(f"Loading Qwen2.5-7B from: {MODEL_PATH}")
...
print("Model loaded and LoRA applied (4-bit QLoRA).")
...
# Main
# ------------------------------------------------------------------
print("Starting Qwen2.5-7B QLoRA training...")
