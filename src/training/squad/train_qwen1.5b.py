"""
Train Qwen2.5-1.5B on SQuAD 2.0 (groups A, B1, B2, C).
...
OUTPUT_BASE = QWEN_1_5B_SQUAD_ADAPTER
...
print("Model loaded with 4-bit quantization and LoRA applied.")
...
def train_group(group_name, seed):
    ...
    if checkpoint_dir.exists():
        print(f"=== {group_name} - seed {seed} done, skipping ===")
        return
