"""
Generate Table 1: SQuAD 2.0 full statistics (F1 and HER) for all models and cleaning strategies.
...
# Raw data from SQuAD 2.0 experiments
data = [
...
# Save to CSV
df.to_csv(TABLES_DIR / "table1_squad_stats.csv", index=False)
print(f"[INFO] Table 1 saved to {TABLES_DIR / 'table1_squad_stats.csv'}")