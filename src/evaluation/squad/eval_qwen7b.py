"""
Evaluate Qwen2.5-7B on SQuAD 2.0.
...
ADAPTER_BASE = QWEN_7B_SQUAD_ADAPTER
EVAL_FILE = SQUAD_EVAL_FILE
OUTPUT_DIR = SQUAD_OUTPUT_DIR / "Qwen7B"
...
# ------------------------------------------------------------------
print("Loading fixed 2000-sample evaluation set...")
...
# ------------------------------------------------------------------
print("Loading Qwen2.5-7B base model (4-bit)...")
...
print("\n" + "="*60)
print("Qwen2.5-7B Evaluation Summary (2000 samples, 10 seeds)")
print("="*60)
print(summary)

csv_path = OUTPUT_DIR / "qwen2.5_7b_2000_eval_results.csv"
...
ax.set_title("Qwen2.5-7B F1 Score by Cleaning Strategy (10 seeds)")
ax.set_ylim(0, 1)
ax.grid(axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "qwen2.5_7b_f1_comparison.png", dpi=300)
print(f"F1 plot saved to {OUTPUT_DIR / 'qwen2.5_7b_f1_comparison.png'}")

fig, ax = plt.subplots(figsize=(8,6))
ax.bar(groups, her_means, yerr=her_stds, capsize=5, color=colors)
ax.set_ylabel("Hallucination Rate (HER)")
ax.set_title("Qwen2.5-7B HER by Cleaning Strategy (10 seeds)")
ax.set_ylim(0, 1)
ax.grid(axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "qwen2.5_7b_her_comparison.png", dpi=300)
print(f"HER plot saved to {OUTPUT_DIR / 'qwen2.5_7b_her_comparison.png'}")
