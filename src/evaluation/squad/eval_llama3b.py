"""
Evaluate Llama-3.2-3B on SQuAD 2.0.
...
ADAPTER_BASE = LLAMA_3_2_3B_SQUAD_ADAPTER
EVAL_FILE = SQUAD_EVAL_FILE
OUTPUT_DIR = SQUAD_OUTPUT_DIR / "Llama3.2-3B"
...
# ------------------------------------------------------------------
print("Loading Llama-3.2-3B base model with 4-bit...")
...
print("\n" + "="*60)
print("Llama-3.2-3B Evaluation Summary (2000 samples, 10 seeds) - 4-bit")
print("="*60)
print(summary)

df.to_csv(OUTPUT_DIR / "llama32_2000_eval_results.csv", index=False)
print(f"\nResults saved to {OUTPUT_DIR / 'llama32_2000_eval_results.csv'}")