"""
Evaluate Llama-3.2-3B on NQ-Open.
...
ADAPTER_BASE = LLAMA_3_2_3B_ADAPTER
OUTPUT_DIR = NQ_RESULTS / "Llama3.2-3B"
...
# ------------------------------------------------------------------
print(f"\n{'='*60}")
print("Evaluating Llama3.2-3B on NQ-Open")
print(f"{'='*60}")
...
for group in GROUPS:
    for seed in SEEDS:
        ...
        results.append({"model": "Llama3.2-3B", "group": group, "seed": seed, "F1": avg_f1})
