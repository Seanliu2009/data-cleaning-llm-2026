"""
Evaluate Qwen2.5-7B on NQ-Open.
...
ADAPTER_BASE = QWEN_7B_ADAPTER
OUTPUT_DIR = NQ_RESULTS / "Qwen7B"
...
# ------------------------------------------------------------------
print(f"\n{'='*60}")
print("Evaluating Qwen7B on NQ-Open")
print(f"{'='*60}")
...
for group in GROUPS:
    for seed in SEEDS:
        ...
        results.append({"model": "Qwen7B", "group": group, "seed": seed, "F1": avg_f1})
